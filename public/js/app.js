...
window.sendEmail = function () {
  var node = document.getElementById('data').innerText;
  var mailToLink = "mailto:?body=" + encodeURIComponent(node);
...
window.saveImage = function () {
  ...
  html_to_image__WEBPACK_IMPORTED_MODULE_2___default.a.toPng(node).then(function (dataUrl) {
    var date = new Date();
    downloadjs__WEBPACK_IMPORTED_MODULE_3___default()(dataUrl, 'browser_is-' + date.toUTCString() + '.png');
