...
<template>
    <article class="p-8 mx-4 mt-8 md:mt-0 md:mx-0 md:w-4/12 rounded max-w-5xl text-black border-primary/10 border bg-white dark:bg-gray-800 dark:text-white mb-8">
