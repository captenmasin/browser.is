        ...
        <div class="max-w-4xl mx-auto">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg" id="data">
                <div class="px-4 py-5 border-b border-gray-200 sm:px-6">
                    ...
                    <nav class="mt-1 max-w-2xl text-sm leading-5 text-gray-500" id="nav-links">
                        <a href="{{ route('home', ['type' => null]) }}"
                           class="text-blue-500 hover:underline {{ $type == null ? 'font-bold' : '' }}">All</a>
                        <span> / </span>
                        <a href="{{ route('home', ['type' => 'device']) }}"
                           class="text-blue-500 hover:underline {{ $type == 'device' ? 'font-bold' : '' }}">Device</a>
                        <span> / </span>
                        <a href="{{ route('home', ['type' => 'browser']) }}"
                           class="text-blue-500 hover:underline {{ $type == 'browser' ? 'font-bold' : '' }}">Browser</a>
                        <span> / </span>
                        <a href="{{ route('home', ['type' => 'location']) }}"
                           class="text-blue-500 hover:underline {{ $type == 'location' ? 'font-bold' : '' }}">Location</a>
                    </nav>
                </div>
