...
namespace Illuminate\Support\Facades {
     ...
     * @method static void factory(string $abstract)
     ...
     * @method static \Illuminate\Database\Query\Builder table(\Illuminate\Database\Query\Builder|string $table, null|string $as = null)
     * @see \Illuminate\Database\Connection::getRawPdo
     * @method static null|\PDO getRawPdo()
     ...
     * @method static null|\PDO getRawReadPdo()
     ...
     * @method static \Closure makeListener(string $listener, bool $wildcard = false)
     * @see \Illuminate\Support\Traits\Macroable::macro
     * @method static void macro(string $name, callable|object $macro)
     ...
     * @method static void send(array|\Illuminate\Contracts\Mail\Mailable|string $view, array $data = [], null|string $callback = null)
     ...
     * @method static null limiter(string $name)
     ...
     * @method static \Symfony\Component\HttpFoundation\StreamedResponse streamDownload($callback, null|string $name = null, array $headers = [], null|string $disposition = 'attachment')
     ...
     * @method static \Symfony\Component\HttpFoundation\StreamedResponse stream($callback, int $status = 200, array $headers = [])
     ...
     * @method static void group(array $attributes, string $routes)
     ...
     * @method static null getBindingCallback(string $key)
